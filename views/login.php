...
<form action="../app/proses/auth.php?action=login" method="post" class="bg-gray-800 p-8 rounded-lg shadow-md">
    <h2 class="text-2xl font-bold mb-6 neon-text">Login to Neotokyo Marketplace</h2>
    <div class="mb-4">
    ...
    <div class="mb-4">
        <label for="password" class="block text-gray-300">Confirm Password</label>
        <input type="password" name="cPassword" id="cPassword" class="w-full bg-gray-700 border border-gray-600 rounded-md p-2">
    </div>
    <input type="submit" value="Login" class="w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition duration-300">
    <p class="mt-4 text-gray-300">Belum punya akun? <a href="register.php" class="text-blue-500 hover:underline">Register</a></p>
